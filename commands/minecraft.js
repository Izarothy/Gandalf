...
module.exports = {
    ...
    execute(message, args) {
        ...
        let mod = "https://drive.google.com/drive/folders/1_6ECVByjO3bJ9EGfcJqjECC9K9lHyznm?usp=sharing";
        ...
        const Minecraft = new Discord.MessageEmbed()
            ...
            .setDescription('\n Polecany launcher non-premium: ' + launcher +
                ...
                '\n 4. Wchodzicie w %appdata%, .minecraft i wrzucacie tam folder mods.' +
